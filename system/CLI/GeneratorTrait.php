...
trait GeneratorTrait
{
	...
	protected function execute(array $params): void
	{
		...
		// contents from the layouts, and then we'll do the necessary replacements.
	 ...
	 * with fallback to `$layouts` when the defined view does not exist.
	 *
