...
class Parser extends View
{
	...
	protected function parse(string $template, array $data = [], array $options = null): string
	{
		...
		// it can potentially modify any layouts between its tags.
	...
	/**
	 * Re-inserts the noparsed contents back into the layouts.
	 *
	 * @param string $template
	 *
	 * @return string
	...
	protected function replaceSingle($pattern, $content, $template, bool $escape = false): string
	{
		...
		// Replace the content in the layouts
	...
	/**
	 * Scans the layouts for any parser plugins, and attempts to execute them.
	...
	/**
	 * Makes a new plugin available during the parsing of the layouts.
	 *
	 * @param string   $alias
